...
public class NewFlyingPathNavigation extends FlyingPathNavigation {
    private float distancemodifier = 1.5F;

    public NewFlyingPathNavigation(Mob p_26424_, Level p_26425_) {
    ...
    public NewFlyingPathNavigation canFloat(boolean canFloat) {
